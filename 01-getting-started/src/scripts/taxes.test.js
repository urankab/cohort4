...
// test('Check that empty function prints correctly', () => {
//     expect(taxFunc.getIncomeTax()).toBe("Please enter your income");
// });
...
test('Check that the income tax function works', () => {
    ...
    // expect(taxFunc.getIncomeTax(160000)).toBe(true);
    // expect(taxFunc.getIncomeTax(250000)).toBe(true);
});