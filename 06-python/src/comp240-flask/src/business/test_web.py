...
#     rv = client.post('/add', json=calgary)
...
#     rv = client.post('/delete', json={"city": "calgary"})
#     assert (rv.status_code == 400)
#     json = rv.get_json()
#     assert ("msg" in json)

#     # delete one that does not exist and make sure it fails
#     rv = client.post('/delete', json={"key": 9, "city": "calgary"})
#     assert (rv.status_code == 400)
#     json = rv.get_json()
#     assert ("msg" in json)
...
#     rv = client.post('/delete', json=calgary)
#     assert (rv.status_code == 200)
...
#     rv = client.post('/read', json={"city": "calgary"})
#     assert (rv.status_code == 400)
#     json = rv.get_json()
#     assert ("msg" in json)

#     # read one that does not exist and make sure it fails
#     rv = client.post('/read', json={"key": 9, "city": "calgary"})
#     assert (rv.status_code == 400)
#     json = rv.get_json()
#     assert ("msg" in json)
...
#     rv = client.post('/read', json=calgary)
#     assert (rv.status_code == 200)
#     json = rv.get_json()
...
#     rv = client.post('/update', json={"city": "calgary"})
#     assert (rv.status_code == 400)
#     json = rv.get_json()
#     assert ("msg" in json)

#     # update one that does not exist and make sure it fails
#     rv = client.post('/update', json={"key": 9, "city": "calgary"})
#     assert (rv.status_code == 400)
#     json = rv.get_json()
#     assert ("msg" in json)
...
#     # add a second one
#     rv = client.post('/add', json=edmonton)
#     assert (rv.status_code == 200)
...
#     rv = client.post('/delete', json={"key": edmonton["key"]})
#     assert (rv.status_code == 200)
